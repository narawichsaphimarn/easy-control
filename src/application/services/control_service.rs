...
impl ControlServiceApplication {
    ...
    pub async fn mouse_control(
        ...
        loop {
            ...
            // log::debug!("X {} Y {} E {}", _data_mouse_event.x, _data_mouse_event.y, _data_mouse_event.edge);
    ...
    pub async fn screen_event(
        ...
        let s_matrix: Vec<ScreenMappingMatrix> =
            ScreenMappingMetricRepository::find_all().map_err(|e| e.to_string())?;
        ...
        loop {
            ...
            loop {
                if *_mouse_switch == false {
                    ...
                    if !_data_mouse_event.edge.eq_ignore_ascii_case("NONE")
                        && !_data_mouse_event.edge.is_empty()
                    {
                        let s_matrix_match = s_matrix.iter().find(|x| {
